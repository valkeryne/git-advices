# Изучение Git
Добро пожаловать! <br>
В данной инструкции описаны основные команды для Git с комментариями по их использованию.
...
В ответе будет следующее сообщение:
user.name=Username
...
Если требуется удалить в определенной папке Git-репозиторий, выполняем следующую команду, находясь в требуемой папке:
```
$ rm -rf .git
